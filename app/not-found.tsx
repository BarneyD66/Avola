      ...
      <main className="relative flex-1 pt-36 pb-14 sm:pt-32 sm:pb-20">
        <div className="mx-auto flex w-full max-w-4xl flex-col gap-6 px-4 sm:px-6 lg:px-8">
          <section className="rounded-[30px] border border-white/8 bg-white/[0.02] p-8 shadow-[0_20px_60px_rgba(0,0,0,0.3)] backdrop-blur-sm sm:p-10">
            ...
            <Link
              href="/"
              className="mt-8 inline-flex w-fit items-center justify-center rounded-full border border-accent/30 bg-accent-soft px-4 py-3 text-sm font-medium text-accent-strong hover:border-accent/50 hover:bg-accent/18 hover:text-white active:scale-[0.98]"
            >
