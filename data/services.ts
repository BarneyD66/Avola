...
const packageMap: Record<string, ServicePackage[]> = {
  "x-follow": createPackages("x-follow", [
    { price: "$50", result: "约 500 关注", deliveryTime: "6-24 小时" },
    {
      price: "$100",
      result: "约 1,200 关注",
    ...
    { price: "$200", result: "约 2,800 关注", deliveryTime: "24-48 小时" },
  ]),
  "x-like": createPackages("x-like", [
    { price: "$30", result: "约 300 点赞", deliveryTime: "6-24 小时" },
    {
      price: "$80",
      result: "约 1,000 点赞",
      deliveryTime: "12-24 小时",
    ...
    { price: "$150", result: "约 2,200 点赞", deliveryTime: "24-36 小时" },
  ]),
  "x-comment": createPackages("x-comment", [
    { price: "$45", result: "约 60 评论", deliveryTime: "12-24 小时" },
    {
      price: "$120",
      result: "约 160 评论",
      deliveryTime: "12-36 小时",
      recommended: true,
    },
    { price: "$220", result: "约 360 评论", deliveryTime: "24-48 小时" },
  ]),
  "x-retweet": createPackages("x-retweet", [
    { price: "$40", result: "约 250 转推", deliveryTime: "6-24 小时" },
    {
      price: "$90",
      result: "约 700 转推",
      deliveryTime: "12-24 小时",
    ...
    { price: "$180", result: "约 1,600 转推", deliveryTime: "24-36 小时" },
  ]),
  "x-kol-comment": createPackages("x-kol-comment", [
    { price: "$160", result: "约 20 条评论", deliveryTime: "12-36 小时" },
    {
      price: "$300",
      result: "约 45 条评论",
      deliveryTime: "24-48 小时",
      recommended: true,
    },
  ...
  "instagram-like": createPackages("instagram-like", [
    ...
    { price: "$135", result: "约 2,600 点赞", deliveryTime: "24-36 小时" },
  ]),
  "instagram-comment": createPackages("instagram-comment", [
    { price: "$55", result: "约 80 评论", deliveryTime: "12-24 小时" },
    {
      price: "$140",
      result: "约 220 评论",
      deliveryTime: "12-36 小时",
    ...
    { price: "$260", result: "约 480 评论", deliveryTime: "24-48 小时" },
  ]),
  ...
  "facebook-like": createPackages("facebook-like", [
    { price: "$30", result: "约 400 点赞", deliveryTime: "6-24 小时" },
    {
      price: "$78",
      result: "约 1,200 点赞",
      deliveryTime: "12-24 小时",
    ...
    { price: "$145", result: "约 2,800 点赞", deliveryTime: "24-36 小时" },
  ]),
  ...
  "telegram-join-group": createPackages("telegram-join-group", [
    ...
    },
    {
      price: "$140",
      result: "约 900 人加入群组",
      deliveryTime: "24-36 小时",
      recommended: true,
    },
    { price: "$260", result: "约 2,000 人加入群组", deliveryTime: "24-48 小时" },
  ]),
  ...
  "tiktok-like": createPackages("tiktok-like", [
    { price: "$28", result: "约 500 点赞", deliveryTime: "6-24 小时" },
    {
      price: "$75",
      result: "约 1,500 点赞",
      deliveryTime: "12-24 小时",
    ...
    { price: "$145", result: "约 3,500 点赞", deliveryTime: "24-36 小时" },
  ]),
  ...
  "discord-join-group": createPackages("discord-join-group", [
    { price: "$60", result: "约 250 人加入群组", deliveryTime: "12-24 小时" },
    {
      price: "$140",
      result: "约 800 人加入群组",
      deliveryTime: "24-36 小时",
    ...
    { price: "$260", result: "约 1,800 人加入群组", deliveryTime: "24-48 小时" },
  ]),
  ...
  "threads-like": createPackages("threads-like", [
    { price: "$28", result: "约 450 点赞", deliveryTime: "6-24 小时" },
    {
      price: "$75",
      result: "约 1,300 点赞",
      deliveryTime: "12-24 小时",
    ...
    { price: "$145", result: "约 3,000 点赞", deliveryTime: "24-36 小时" },
  ]),
  ...
  "binance-follow": createPackages("binance-follow", [
    { price: "$50", result: "约 400 关注", deliveryTime: "6-24 小时" },
    {
      price: "$110",
      result: "约 1,000 关注",
      deliveryTime: "12-24 小时",
    ...
    { price: "$210", result: "约 2,200 关注", deliveryTime: "24-48 小时" },
  ]),
  "twitter-growth": createPackages("twitter-growth", [
    { price: "$50", result: "约 500 粉丝", deliveryTime: "6-24 小时" },
    {
      price: "$100",
      result: "约 1,200 粉丝",
      deliveryTime: "12-24 小时",
    ...
    { price: "$200", result: "约 2,800 粉丝", deliveryTime: "24-48 小时" },
  ]),
  "tweet-engagement": createPackages("tweet-engagement", [
    { price: "$30", result: "约 300 互动", deliveryTime: "6-24 小时" },
    {
      price: "$85",
      result: "约 1,000 互动",
      deliveryTime: "12-24 小时",
    ...
    { price: "$160", result: "约 2,400 互动", deliveryTime: "24-36 小时" },
  ]),
  "verified-comments": createPackages("verified-comments", [
    { price: "$100", result: "约 40 条评论", deliveryTime: "12-24 小时" },
    {
      price: "$220",
      result: "约 100 条评论",
      deliveryTime: "24-36 小时",
    ...
    { price: "$420", result: "约 220 条评论", deliveryTime: "24-48 小时" },
  ]),
  "airdrop-campaign": createPackages("airdrop-campaign", [
    { price: "$200", result: "约 800 参与", deliveryTime: "24-48 小时" },
    {
      price: "$420",
      result: "约 2,000 参与",
      deliveryTime: "24-72 小时",
      recommended: true,
    },
    { price: "$780", result: "约 4,500 参与", deliveryTime: "48-72 小时" },
  ]),
  "github-stars": createPackages("github-stars", [
    { price: "$20", result: "约 50 Stars", deliveryTime: "6-24 小时" },
    {
      price: "$50",
      result: "约 150 Stars",
      deliveryTime: "12-24 小时",
    ...
    { price: "$100", result: "约 400 Stars", deliveryTime: "24-48 小时" },
  ]),
  "app-download-review": createPackages("app-download-review", [
    { price: "$80", result: "约 300 下载 + Review", deliveryTime: "24-48 小时" },
    {
      price: "$180",
    ...
    { price: "$360", result: "约 2,000 下载 + Review", deliveryTime: "48-72 小时" },
  ]),
  "site-register": createPackages("site-register", [
    { price: "$70", result: "约 120 次注册", deliveryTime: "12-24 小时" },
    {
      price: "$160",
      result: "约 320 次注册",
      deliveryTime: "24-36 小时",
    ...
    { price: "$300", result: "约 700 次注册", deliveryTime: "24-48 小时" },
  ]),
  "site-register-interaction": createPackages("site-register-interaction", [
    { price: "$120", result: "约 100 次注册 + 交互", deliveryTime: "24-36 小时" },
    {
      price: "$260",
      result: "约 260 次注册 + 交互",
      deliveryTime: "24-48 小时",
    ...
    { price: "$480", result: "约 560 次注册 + 交互", deliveryTime: "48-72 小时" },
  ]),
  "site-register-paid-interaction": createPackages("site-register-paid-interaction", [
    { price: "$180", result: "约 80 次注册 + 付费交互", deliveryTime: "24-48 小时" },
    {
      price: "$360",
    ...
    { price: "$680", result: "约 420 次注册 + 付费交互", deliveryTime: "48-72 小时" },
  ]),
  "site-register-kyc": createPackages("site-register-kyc", [
    { price: "$120", result: "约 80 次注册（含 KYC）", deliveryTime: "24-48 小时" },
    {
      price: "$260",
    ...
    { price: "$480", result: "约 420 次注册（含 KYC）", deliveryTime: "48-72 小时" },
  ]),
  "site-register-kyc-interaction": createPackages("site-register-kyc-interaction", [
    { price: "$180", result: "约 60 次注册（含 KYC）+ 交互", deliveryTime: "24-48 小时" },
    {
      price: "$360",
  ...
  "github-forks": createPackages("github-forks", [
    { price: "$35", result: "约 30 Forks", deliveryTime: "12-24 小时" },
    {
      price: "$80",
      result: "约 90 Forks",
      deliveryTime: "12-36 小时",
    ...
    { price: "$160", result: "约 220 Forks", deliveryTime: "24-48 小时" },
  ]),
  "token-nft-presale": createPackages("token-nft-presale", [
    { price: "$220", result: "约 120 次参与", deliveryTime: "24-48 小时" },
    {
      price: "$460",
      result: "约 320 次参与",
      deliveryTime: "24-72 小时",
    ...
    { price: "$860", result: "约 750 次参与", deliveryTime: "48-72 小时" },
  ]),
  "token-buy": createPackages("token-buy", [
    { price: "$260", result: "约 100 次买币参与", deliveryTime: "24-48 小时" },
    {
      price: "$520",
      result: "约 260 次买币参与",
      deliveryTime: "24-72 小时",
    ...
    { price: "$980", result: "约 620 次买币参与", deliveryTime: "48-72 小时" },
  ]),
  "token-hold": createPackages("token-hold", [
    { price: "$280", result: "约 100 次持币参与", deliveryTime: "24-48 小时" },
    {
      price: "$560",
      result: "约 260 次持币参与",
      deliveryTime: "24-72 小时",
    ...
    { price: "$1,020", result: "约 620 次持币参与", deliveryTime: "48-72 小时" },
  ]),
  "app-download": createPackages("app-download", [
    { price: "$80", result: "约 500 下载", deliveryTime: "24-48 小时" },
    {
      price: "$150",
      result: "约 1,200 下载",
      deliveryTime: "24-72 小时",
    ...
    { price: "$300", result: "约 3,000 下载", deliveryTime: "48-72 小时" },
  ]),
  "app-review": createPackages("app-review", [
    { price: "$90", result: "约 80 条评价", deliveryTime: "24-48 小时" },
    {
      price: "$180",
      result: "约 220 条评价",
      deliveryTime: "24-72 小时",
    ...
    { price: "$360", result: "约 520 条评价", deliveryTime: "48-72 小时" },
  ]),
};
