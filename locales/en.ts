...
export const en: Messages = {
  ...
  home: {
    ...
    notice: {
      ...
      moduleDescription:
        "Review the flow, rules, and support details before ordering.",
      title: "Service Notes",
      rulesTitle: "Ordering Rules",
      paragraphs: [
        "Confirm your service needs before ordering.",
        "Orders are non-refundable after payment. Please review everything before checkout.",
        "Crypto is currently the only supported payment method.",
      ],
      supportTitle: "Support",
      supportLabel: "Support:",
      supportHandle: "@Avolaofficial",
      rules: [
        "All services are delivered through real user participation.",
        "Use your order number and query password to track progress.",
        "Keep your query details secure.",
        "Disclaimer: These services are for learning and testing only. Do not use them for illegal activity.",
      ],
    },
    categories: {
