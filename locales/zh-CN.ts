export const zhCN = {
  ...
  home: {
    intro: {
      ...
      title: "让每一笔增长预算\n都转化成真实用户参与",
      description:
        "不做虚假刷量，只交付真实用户参与。平台连接 5000+ 海外 Web3 真实用户网络，并整合 200+ KOL 资源。",
    ...
    landing: {
      ...
      title: "交付可追踪的增长结果",
      description:
        "REALJOIN 更像一个面向项目方的增长执行承接层：不止提供曝光入口，而是围绕实际参与、任务执行与结果回传，完成更完整的增长交付。",
      cta: "进入服务目录",
      cards: [
        {
          label: "真实参与与质量",
          title: "真实用户参与",
          description: "不只带来曝光，更带来真实互动与任务参与。",
        },
        {
          label: "可追踪交付链路",
          title: "可追踪的订单链路",
          description: "从下单、支付到执行与结果回传，关键进度都可持续查看。",
        },
        {
          label: "面向项目团队",
          title: "面向项目结果交付",
          description: "更适合需要明确执行、稳定配合与阶段性交付的项目需求。",
        },
      ],
    },
    flow: {
    ...
    trust: {
      eyebrow: "适用场景",
      title: "适配多种 Web3 增长场景",
      description:
        "无论是项目预热、社区增长，还是活动参与与转化配合，我们都能提供更贴近实际需求的交付方式。",
      cards: [
        {
          title: "项目预热",
          description: "为新项目上线前积累首轮热度与讨论基础。",
        },
        {
          title: "社区增长",
          description: "支持群组加入、内容互动与持续活跃提升。",
        },
        {
          title: "活动参与",
          description: "适配 Giveaway、任务活动、榜单冲刺等场景。",
        },
        {
          title: "转化配合",
          description: "覆盖注册、下载、购买与后续互动等动作。",
        },
      ],
    },
    manifesto: {
