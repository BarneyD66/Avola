...
export function CategoryPreviewList({ items }: CategoryPreviewListProps) {
  ...
  return (
    <div className="rounded-[18px] border border-white/6 bg-white/[0.02] px-3 py-3 sm:px-3.5">
      <ul
        ...
        {items.map((item, index) => {
          ...
          return (
            ...
            >
              <span
                aria-hidden="true"
                className="mt-[0.55rem] h-1.5 w-1.5 shrink-0 rounded-full bg-accent-strong/80 shadow-[0_0_0_4px_rgba(59,130,246,0.06)]"
              />
